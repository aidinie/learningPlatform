...
define(function(require, exports, module) {
    (function() {
        ...
        var __creator = function(o, proto) {
            ...
            var empty = function() {};
            var n = Object.create ?
                Object.create(proto) : new Object(empty.prototype = proto, empty);
        ...
        juicer.template = function(options) {
            ...
            this.__removeShell = function(tpl, options) {
                ...
                .replace(juicer.settings.forstart, function($, _name, alias, key) {
                    var _alias = alias || 'value',
                        _key = key && key.substr(1);
                    var _iterate = 'i' + _counter++;
                    return '<% ~function() {' +
                        'for(var ' + _iterate + ' in ' + _name + ') {' +
                        'if(' + _name + '.hasOwnProperty(' + _iterate + ')) {' +
                        'var ' + _alias + '=' + _name + '[' + _iterate + '];' +
                        (_key ? ('var ' + _key + '=' + _iterate + ';') : '') +
                        ' %>';
                })
                ...
                .replace(juicer.settings.include, function($, tpl, data) {
                    ...
                    var _str = '<%= _method.__juicer(' + tpl + ', ' + data + '); %>';
                    return _str;
                });
            ...
            this.__lexicalAnalyze = function(tpl) {
                ...
                var variableAnalyze = function($, statement) {
                    ...
                    if (indexOf(buffer, statement) === -1 && indexOf(reserved, statement) === -1 && indexOf(method, statement) === -1) {
                        ...
                        if (typeof(window) !== 'undefined' && typeof(window[statement]) === 'function' &&
                        ...
                        // compatible for node.js
                        var global = {};
                        if (typeof(global) !== 'undefined' && typeof(global[statement]) === 'function' &&
                ...
                for (var j = 0; j < method.length; j++) {
                    prefix += 'var ' + method[j] + '=_method.' + method[j] + ';';
                }
